...
export function createRetrieveKnowledge(traceId?: string) {
  return tool({
    description:
    ...
    execute: async ({ query, top_k }) => {
      ...
      return await invokePythonTool("retrieve_knowledge", args, traceId);
    },
...
export const retrieveKnowledge = createRetrieveKnowledge();
